...
--
-- Host: localhost
-- Generation Time: Dec 04, 2022 at 07:52 PM
...
CREATE TABLE `bookings` (
  ...
  `request_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pickup` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destationation` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
...
INSERT INTO `bookings` (`id`, `user_id`, `name`, `mobile`, `request_date`, `pickup`, `destationation`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Alesha Mart', '01949838735', '2022-09-24', 'Dhaka', 'Noakhali', 'Approved', '2022-09-24 12:56:16', '2022-09-24 14:07:56'),
(2, NULL, 'Alesha Mart', '01949838735', '2022-09-23', 'Dhaka', 'Noakhali', 'Approved', '2022-09-24 12:57:11', '2022-09-24 14:11:15'),
(3, 9, 'Alesha Mart', '01949838735', '2022-09-22', 'Dhaka', 'Noakhali', 'Pending', '2022-09-24 12:58:28', '2022-09-24 12:58:28'),
(4, 9, 'Alesha Mart', '01949838735', '2022-09-08', 'Dhaka', 'Noakhali', 'Pending', '2022-09-24 13:10:35', '2022-09-24 13:10:35'),
(5, 2, 'Farhan Tanvir', '01949838735', '2022-09-17', 'Dhaka', 'Noakhali', 'Approved', '2022-09-24 14:34:03', '2022-09-24 14:35:02'),
(6, 13, 'Alesha Mart', '01949838735', '2022-09-10T02:59', 'Dhaka', 'Noakhali', 'Pending', '2022-09-24 14:57:54', '2022-09-24 14:57:54'),
(7, 10, 'Farhan', '01949838735', '2022-09-26T00:13', 'Dhaka', 'Noakhali', 'Approved', '2022-09-25 12:10:37', '2022-09-25 12:12:56');
...
CREATE TABLE `complanes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `perpose` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transport_name` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `complane_message` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `complanes` (`id`, `perpose`, `transport_name`, `complane_message`, `created_at`) VALUES
(1, 'Transport', 'Dhaka-1208', 'When used simultaneously with cardiac glycosides, a potassium and/or magnesium deficiency may increase sensitivity of the cardiac muscle to such drugs. The kaliuretic effect of mineralo-and glucocorticoids and laxatives may be increased.', '2022-08-27 17:37:41'),
(2, 'Hello', 'Dhaka-1208', 'When used simultaneously with cardiac glycosides, a potassium and/or magnesium deficiency may increase sensitivity of the cardiac muscle to such drugs. The kaliuretic effect of mineralo-and glucocorticoids and laxatives may be increased.', '2022-09-13 11:32:54'),
(3, 'fr', 'Dhaka-1208', 'When used simultaneously with cardiac glycosides, a potassium and/or magnesium deficiency may increase sensitivity of the cardiac muscle to such drugs. The kaliuretic effect of mineralo-and glucocorticoids and laxatives may be increased.', '2022-09-13 11:35:26'),
(4, 'Driver', 'Dhaka-1208', 'When used simultaneously with cardiac glycosides, a potassium and/or magnesium deficiency may increase sensitivity of the cardiac muscle to such drugs. The kaliuretic effect of mineralo-and glucocorticoids and laxatives may be increased.', '2022-09-18 18:04:00'),
(5, 'Driver', 'Dhaka-1208', 'When used simultaneously with cardiac glycosides, a potassium and/or magnesium deficiency may increase sensitivity of the cardiac muscle to such drugs. The kaliuretic effect of mineralo-and glucocorticoids and laxatives may be increased.', '2022-09-25 18:48:20');
...
CREATE TABLE `drivers` (
  ...
  `mobile_number` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `licence_number` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `licence_experdate_date` date NOT NULL,
  `nid` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nid_photo` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `driver_photo` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `drivers` (`id`, `name`, `date_of_birth`, `mobile_number`, `licence_number`, `licence_experdate_date`, `nid`, `nid_photo`, `driver_photo`, `created_at`, `updated_at`) VALUES
(1, 'Abul Miya', '2022-07-18', '+8801840838735', '1234567890', '2022-07-19', '1234567890987654', '/images/1200x675.jpeg', '/images/1200x675.jpeg', NULL, NULL),
(3, 'Alesha Mart', '2022-09-01', '+8801840838735', '1234567890', '2022-09-30', '1234567890987654', '/images/Screenshot 2022-09-01 at 12.27.37 AM.png', '/images/Screenshot 2022-09-01 at 12.27.37 AM.png', NULL, NULL),
(4, 'Alesha Mart', '2022-09-10', '+8801840838735', '1234567890', '2022-09-10', '1234567890987654', '/images/profile_image/22-09-17-04-26-46_1663432006_1200x675.jpeg', '/images/profile_image/22-09-17-04-26-46_1663432006_1200x675.jpeg', NULL, NULL),
(5, 'Farhan', '2022-09-01', '+8801840838735', '1234567890', '2022-09-19', '1234567890987654', '/images/profile_image/22-09-17-06-28-20_1663439300_1200x675.jpeg', '/images/profile_image/22-09-17-06-28-20_1663439300_1200x675.jpeg', NULL, NULL),
(6, 'Farhan Tanvir', '2022-09-02', 'farhan.tanvir7471@gmail.com', '1234567890', '2022-09-02', '1234567890987654', '/images/profile_image/22-09-18-07-30-35_1663529435_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-30-35_1663529435_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(7, 'Farhan Tanvir', '2022-09-02', 'farhan.tanvir7471@gmail.com', '1234567890', '2022-09-02', '1234567890987654', '/images/profile_image/22-09-18-07-30-49_1663529449_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-30-49_1663529449_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(8, 'Driver', '2022-09-06', '01890987876', '1234567890', '2022-09-09', '1234567890987654', '/images/profile_image/22-09-19-07-22-20_1663615340_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-19-07-22-20_1663615340_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL);
...
(13, '2020_06_08_192326_create_transports_table', 6),
(14, '2020_06_10_181931_create_drivers_table', 6),
(15, '2020_06_10_194635_create_transport_managers_table', 6),
(16, '2020_06_10_203538_create_tranaport_associates_table', 6),
(17, '2020_06_18_183756_create_complanes_table', 6),
(18, '2020_07_06_161802_create_transportschedules_table', 6),
(19, '2022_09_24_170432_create_bookings_table', 7);
...
--
-- Table structure for table `tranaport_associates`
--

CREATE TABLE `tranaport_associates` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `fk_transport_id` bigint(20) NOT NULL,
  `fk_driver_id` bigint(20) NOT NULL,
  `fk_managers_id` bigint(20) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tranaport_associates`
--

INSERT INTO `tranaport_associates` (`id`, `fk_transport_id`, `fk_driver_id`, `fk_managers_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, NULL, NULL),
(2, 4, 5, 5, NULL, NULL),
(3, 5, 1, 7, NULL, NULL),
(4, 6, 1, 5, NULL, NULL);
...
CREATE TABLE `transports` (
  ...
  `mpdel` char(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `coler` char(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `licence_number` bigint(20) NOT NULL,
  `licence_experdate` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `transports` (`id`, `name`, `type`, `mpdel`, `coler`, `licence_number`, `licence_experdate`, `created_at`, `updated_at`) VALUES
(1, 'E067 ac', 'bus', 'AJ1', 'Black', 1234567890, '2023-11-15', NULL, NULL),
(4, 'Dhaka -2', 'bus', 'AJ1', 'Black', 1234567890, '2022-10-01', NULL, NULL),
(5, 'Ctg-mega', 'truck', 'AJ1', 'Black', 1234567890, '2022-10-08', NULL, NULL),
(6, 'CTG-Ogne', 'truck', 'AJ1', 'Black', 1234567890, '2022-09-30', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `transportschedules`
--

CREATE TABLE `transportschedules` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `schedules_name` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transport_id` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `transportschedules`
--

INSERT INTO `transportschedules` (`id`, `schedules_name`, `transport_id`, `start_time`, `end_time`, `created_at`, `updated_at`) VALUES
(1, 'Morning', '4', '2011-08-19', '2011-08-19', NULL, NULL),
(3, 'Morning', '5', '2011-08-19', '2011-08-19', NULL, NULL),
(4, 'Morning', '6', '2011-08-19', '2011-08-19', NULL, NULL),
(5, 'Day', '4', '2011-08-19', '2011-08-19', NULL, NULL);
...
CREATE TABLE `transport_managers` (
  ...
  `nid` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nid_photo` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `manager_photo` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `transport_managers`
--

INSERT INTO `transport_managers` (`id`, `name`, `date_of_birth`, `mobile_number`, `nid`, `nid_photo`, `manager_photo`, `created_at`, `updated_at`) VALUES
(1, 'Alesha Mart', '2022-07-18', '+8801840838735', '1234567890987654', '/images/1200x675.jpeg', '/images/1200x675.jpeg', NULL, NULL),
(2, 'Image Test', '2022-09-01', '+8801840838735', '1234567890987654', '/images/profile_image/22-09-17-04-23-45_1663431825_1200x675.jpeg', '/images/profile_image/22-09-17-04-23-45_1663431825_1200x675.jpeg', NULL, NULL),
(3, 'Khaliod Khan', '1961-01-19', '+8801840838735', '1234567890987654', '/images/profile_image/22-09-18-06-09-32_1663524572_1200x675.jpeg', '/images/profile_image/22-09-18-06-09-32_1663524572_1200x675.jpeg', NULL, NULL),
(4, 'Farhan Tanvir', '2022-09-06', '+8801840838735', '1234567890987654', '/images/profile_image/22-09-18-07-06-31_1663527991_1200x675.jpeg', '/images/profile_image/22-09-18-07-06-31_1663527991_1200x675.jpeg', NULL, NULL),
(5, 'Farhan Tanvir', '2022-08-31', 'admin@demo.com', '1234567890987654', '/images/profile_image/22-09-18-07-08-34_1663528114_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-08-34_1663528114_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(6, 'Farhan Tanvir', '2022-08-31', 'admin@demo.com', '1234567890987654', '/images/profile_image/22-09-18-07-08-57_1663528137_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-08-57_1663528137_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(7, 'Farhan Tanvir', '2022-08-30', '0909898789', '1234567890987654', '/images/profile_image/22-09-18-07-11-27_1663528287_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-11-27_1663528287_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(8, 'Farhan Tanvir', '2022-09-01', '0909898789', '1234567890987654', '/images/profile_image/22-09-18-07-12-07_1663528327_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-18-07-12-07_1663528327_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL),
(9, 'Farhan Tanvir', '2022-08-30', 'farhan.tanvir7471@gmail.com', '1234567890987654', '/images/profile_image/22-09-24-08-38-05_1664051885_1200x675.jpeg', '/images/profile_image/22-09-24-08-38-05_1664051885_1200x675.jpeg', NULL, NULL),
(10, 'Farhan Tanvir', '2022-08-30', 'farhan.tanvir7471@gmail.com', '1234567890987654', '/images/profile_image/22-09-24-08-38-42_1664051922_1200x675.jpeg', '/images/profile_image/22-09-24-08-38-42_1664051922_1200x675.jpeg', NULL, NULL),
(11, 'Farhan Tanvir', '2022-08-30', 'farhan.tanvir7471@gmail.com', '1234567890987654', '/images/profile_image/22-09-24-08-39-13_1664051953_1200x675.jpeg', '/images/profile_image/22-09-24-08-39-13_1664051953_1200x675.jpeg', NULL, NULL),
(12, 'Farhan Tanvir', '2022-09-02', 'farhan.tanvir7471@gmail.com', '1234567890987654', '/images/profile_image/22-09-24-09-05-01_1664053501_271661716_3150376865193901_7557962560695070681_n.jpeg', '/images/profile_image/22-09-24-09-05-01_1664053501_271661716_3150376865193901_7557962560695070681_n.jpeg', NULL, NULL);
...
(1, 'admin', '01875001213', 'admin', 'admin@gmail.com', NULL, '$2y$10$TmhjAEn/1AD9BQf8CyxrYO0Oqb01qQU4FthwCM7lmcd4dtkz1mi9K', 'iLs60NSMbOeQub2YRYTNJWTekWicfzFIaXkplkgf4NQxPLSSF4zmhe1dAiji', '2020-04-02 06:37:07', '2020-04-02 06:37:07'),
...
(3, 'Farhan Tanvir', 'admin@demo.com', NULL, 'farhan@gmail.com', NULL, '$2y$10$C1SN.IpJSzXOCk6XboGXkeoH.8g8Es2rXHLDrumhPMlFk1sajrI6a', NULL, '2022-09-18 13:08:57', '2022-09-18 13:08:57'),
(5, 'Farhan Tanvir', '0909898789', NULL, 'admin.4@gmail.com', NULL, '$2y$10$PPulUbdGHsdWYwy4eg0fhOsq2sx3XlNpD2UAogSeRXxkoTuGaF1Nm', NULL, '2022-09-18 13:12:07', '2022-09-18 13:12:07'),
(7, 'Farhan Tanvir', 'farhan@gmail.com', 'transport_managers', 'admin3@gmail.com', NULL, '$2y$10$Hoiic1hkx6TeQEmPejgtoOgwSREbqk9orwCCC/p3Mv.Od/WuddVXS', NULL, '2022-09-18 13:30:49', '2022-09-18 13:30:49'),
(8, 'Driver', '01890987876', 'driver', 'driver@gmail.com', NULL, '$2y$10$0aZI.Bz0hIlvOOXSW3O4pOIZiL5x6bIY9ERDj5XK20oEC4hPjBeh.', NULL, '2022-09-19 13:22:20', '2022-09-19 13:22:20'),
(9, 'User Test', '01890989876', NULL, 'user23@gmail.com', NULL, '$2y$10$UvEIXADsr2RVMMl61M9AYe2hjx1cXbfxduYORnX2ctMAfE4jgfxE2', NULL, '2022-09-24 10:16:13', '2022-09-24 10:16:13'),
(10, 'User Test', '01890987865', NULL, 'user12@g.c', NULL, '$2y$10$3Nusf5b/W0fCiROgP6z7CONOZtZGflvHSqgjnimEQj3ap97I0iQ4y', NULL, '2022-09-24 14:13:37', '2022-09-24 14:13:37'),
(13, 'Farhan Tanvir', 'farhan.tanvir7471@gmail.com', 'transport_managers', 'farhan.tanvir7471@gmail.com', NULL, '$2y$10$rMDD04rCSrMHH5.xAeYHrulpJ9SI8ULt57/i0AjDqA29cDpK3AX7O', NULL, '2022-09-24 14:39:13', '2022-09-24 14:39:13'),
(14, 'Farhan Tanvir', 'farhan.tanvir7471@gmail.com', 'transport_managers', 'farhan12m@gmail.com', NULL, '$2y$10$A4sFUne42lROnMcsuIp5sOimHsRORzfX1vVNMMpsmDA2jpmkO8nzy', NULL, '2022-09-24 15:05:01', '2022-09-24 15:05:01');
...
--
-- Indexes for table `tranaport_associates`
--
ALTER TABLE `tranaport_associates`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `transportschedules`
--
ALTER TABLE `transportschedules`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tranaport_associates`
--
ALTER TABLE `tranaport_associates`
...
--
-- AUTO_INCREMENT for table `transportschedules`
--
ALTER TABLE `transportschedules`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
